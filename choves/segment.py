...
def preprocess_vesselseg(img, mmcq=True):
    '''
    ...
    mmcq_kwargs = dict(n_scales=[(10,10), (25,25), (40,40)])
    ...
    if mmcq:
        _, img = enhance.Multiscale_MCQ(img, **mmcq_kwargs)()
...
def vessel_seg(img, bnds, seg_params=(10, 5)):
    '''
    ...
    mmcq = preprocess_vesselseg(roi_img)[-1]
    ...
    #print(f"Mean pixel choroid thickness: {mean_pixel_height} pixels")
    ...
    return rebuild_map(vessel_binmap, img.shape, crop_idx)
